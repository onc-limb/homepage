...
const ArticleDetail = async ({params}: {params: {title: string}}) => {
  ...
  const path = `${__dirname}/../../../../../articles/${decodedTitle}.md`
      ...
      <div className="container px-4 md:px-6 lg:max-w-4xl">
        <div className="space-y-6">
          <div className="space-y-2">
            ...
            <p className="flex-row text-gray-500 dark:text-gray-400">{category}</p>
            <p className="flex-row text-gray-500 dark:text-gray-400">更新日：{editedAt.toLocaleDateString()}</p>
            </div>
          </div>
