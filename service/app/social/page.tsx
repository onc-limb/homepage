                        ...
                        return (
                            <Reveal key={link.name} delay={i * 80}>
                                <Link
                                    ...
                                    className="group flex items-center gap-6 rounded-[var(--radius-lg)] border border-hairline-strong bg-surface-solid p-7 transition-all duration-250 hover:-translate-y-0.5 hover:border-accent hover:shadow-card-soft"
                                >
                                    <div
                                    ...
                                    <span
                                        aria-hidden="true"
                                        className="grid h-9 w-9 shrink-0 place-items-center rounded-full text-fg-muted transition-all duration-250 group-hover:translate-x-1 group-hover:bg-accent group-hover:text-white"
                                    >
                                        ↗
                                    </span>
                                </Link>
