...
export function ProjectCard({ project, number }: ProjectCardProps) {
    ...
    return (
        <article
            ...
            className="proj group relative grid grid-cols-1 gap-6 overflow-hidden rounded-[var(--radius-lg)] border border-hairline-solid bg-surface-solid px-8 py-7 shadow-card transition-all duration-250 hover:-translate-y-0.5 hover:border-accent [@media(min-width:720px)]:grid-cols-[80px_1fr_auto] [@media(min-width:720px)]:items-start"
        >
